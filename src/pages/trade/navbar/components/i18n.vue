<template>
  <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
    ...
    <vs-dropdown-menu class="w-48 i18n-dropdown vx-navbar-dropdown">
      ...
      <!-- <vs-dropdown-item @click="updateLocale('ja')">
        <img class="h-4 w-5 mr-1" src="@/assets/images/flags/ja.png" alt="ja" />
        &nbsp;日本
      </vs-dropdown-item>
      <vs-dropdown-item @click="updateLocale('kr')">
        <img class="h-4 w-5 mr-1" src="@/assets/images/flags/kr.png" alt="kr" />
        &nbsp;한국어
      </vs-dropdown-item> -->
      <vs-dropdown-item @click="updateLocale('cn')">
        <img class="h-4 w-5 mr-1" src="@/assets/images/flags/cn.png" alt="cn" />
        &nbsp;中国
      </vs-dropdown-item>
      <!-- <vs-dropdown-item @click="updateLocale('cam')">
        <img
          class="h-4 w-5 mr-1"
          src="@/assets/images/flags/cam.png"
          alt="cam"
        />
        &nbsp;ប្រទេសកម្ពុជា
      </vs-dropdown-item> -->
      <!-- <vs-dropdown-item @click="updateLocale('thai')">
        <img
          class="h-4 w-5 mr-1"
      ...
      <vs-dropdown-item @click="updateLocale('indo')">
        <img
          class="h-4 w-5 mr-1"
          src="@/assets/images/flags/indo.png"
          alt="indo"
        />
        &nbsp;Indonesian
      </vs-dropdown-item>
      <vs-dropdown-item @click="updateLocale('lao')">
        <img
          class="h-4 w-5 mr-1"
          src="@/assets/images/flags/lao.png"
          alt="lao"
        />
        &nbsp;Lao
      </vs-dropdown-item> -->
