      ...
      <div class="vx-row">
        <div class="w-full">
          <div class="exchange-currency">
            <h4
              class="exchange-currency-title color-white font-bold mb-3 pt-4 capitalize"
            >
              Chuyển đổi tiền tệ
            </h4>
            <div class="vx-row boxExchange">
                ...
                <div class="send">
                  <div class="inputAmount mt-0 mb-1">
                    <div class="flex justify-between items-center">
                      <span class="font-bold font-12-m color-white">Gửi:</span>
                      <div class="inputLabel absolute right-0">
                        <a
                          href="javascript:;"
                          class="butt text-center"
                          @click="ttClickAmount(1)"
                          >Một nửa</a
                        >
                        <a
                          href="javascript:;"
                          class="butt text-center"
                          @click="ttClickAmount(2)"
                          >Tất cả</a
                        >
                      </div>
                    </div>
                  ...
                  <div :class="`wrap-input-exchange ${isCoinOne}`">
                    ...
                    <div class="boxSelectUnit">
                      <div :class="`selectedUnit ${isCoinOne}`">
                        <div :class="`icon ${isCoinOne}`"></div>
                        <span class="color-white font-bold">{{
                          isCoinOne
                        }}</span>
                        <div class="info">
                          <span class="titleUnit"></span>
                          <div class="amount">
                            <span class="label">Số dư của bạn :</span>
                            <span class="number px-1">
                              {{ balanceOne }}
                            </span>
                            <span :class="`symb ${isCoinOne}`">{{
                              isCoinOne
                            }}</span>
                          </div>
                        </div>
              ...
              <div class="vx-col w-full lg:w-4/12">
                <div class="receive">
                  <span
                    class="inputAmount font-bold mt-0 mb-1 inline-block color-white"
                    >Nhận</span
                  >
                  <div :class="`wrap-input-exchange hasitem ${isCoinTwo}`">
                    ...
                    <div class="boxSelectUnit">
                      ...
                      <div :class="`selectedUnit hasitem ${isCoinTwo}`">
                        ...
                        <div class="info">
                          <span class="titleUnit">{{ isCoinTwo }}</span>
                          <div class="amount">
                            <span class="label">Số dư của bạn :</span>
                            <span class="number px-1">
                              {{ balanceTwo }}
                            </span>
                            <span :class="`symb ${isCoinTwo}`">{{
                              isCoinTwo
                            }}</span>
                          </div>
                        </div>
                      ...
                      <div class="listUnits shadow">
                        <div class="itemSelectUnit ETH">
                          ...
                          <div class="info">
                            <span class="titleUnit">Ethereum</span>
                            <!-- <div class="amount">
            ...
            <div class="processExchange">
              <span class="font-12 color-white"
                >Giá trị chuyển đổi nhỏ nhất là
