      ...
      <div class="content-wrapper">
        <div class="router-view">
          <div class="router-content">
            <transition v-if="false" :name="routerTransition">
              <div
...
import Auth2FA from "@/layouts/components/popup/2FA.vue";
...
export default {
  ...
  watch: {
    ...
    isThemeDark(val) {
      const color = this.navbarColor == "#fff" && val ? "#011022" : "#fff";
  ...
  methods: {
    ...
    updateNavbar(val) {
      if (val == "static")
        this.updateNavbarColor(this.isThemeDark ? "#011022" : "#fff");
      this.navbarType = val;
    },
