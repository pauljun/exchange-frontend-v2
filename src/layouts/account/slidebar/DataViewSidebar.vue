  ...
  >
    ...
    >
      <div class="p-6">
        ...
        <template v-if="dataImg">
          ...
          >
            <img
              :src="`${dm}/api/auth/me/photo/${dataImg}`"
              width="100"
              alt="img"
            />
          </div>
        ...
        <vs-input
          ...
          type="email"
          name="item-email"
          v-validate="'required|email|min:6|max:200'"
        />
        <span class="text-danger text-sm" v-show="errors.has('item-email')">{{
        ...
        />
        <span class="text-danger text-sm" v-show="errors.has('item-nick')">{{
          errors.first("item-nick")
        }}</span>
    ...
    >
      <div class="p-6">
        ...
        <span
          class="text-danger text-sm"
          v-show="errors.has('item-wallet_vn')"
          >{{ errors.first("item-wallet_vn") }}</span
        >
        ...
        if (result) {
          ...
          if (Object.entries(this.data).length == 0) {
            AuthenticationService.checkEmail(this.dataEmail).then((resp) => {
              if (resp.data.code === 10000 && resp.data.data.length) {
                return this.$vs.notify({
