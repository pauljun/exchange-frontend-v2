            ...
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
                ...
                <p>
                  ...
                  *** Lời:
                  <span class="italic font-bold" style="color: #00ff89"
                    >${{ formatPrice(tr.priceWin - tr.priceLose, 2) }}</span
                  ><br />
                </p>
              </vs-td>

              <vs-td>
                <p class="agency-name font-medium truncate">
                ...
                <p class="agency-total-member" v-if="!tr.sponsor">
                  ...
                  >
                    <vs-button
                      ...
                      icon-pack="feather"
                      icon="icon-eye"
                      @click.stop="viewPeopelAgency(tr.ref_code, indextr)"
                    >
                      Xem
                    </vs-button>
                  </vx-tooltip>
              ...
              <vs-td>
                <vs-chip
                  ...
                  class="agency-status"
                >
                  {{ getOrderStatusColorText(tr.active_2fa) | title }}
                </vs-chip>
              </vs-td>
...
export default {
  ...
  methods: {
    ...
    viewPeopelAgency(id, index) {
      AuthenticationService.viewMemberAgency(id).then((resq) => {
        if (resq.data.code === 10000) {
