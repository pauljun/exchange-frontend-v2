<template>
  <div id="list-tool-setting" class="data-list-container">
    <template>
      ...
      <div class="vx-row">
        <div class="vx-col md:w-1/2 lg:w-6/12 xl:w-6/12 mb-base">
          ...
          <div class="vx-row">
            ...
            >
              <vs-input
                ...
                class="m-2 mb-4"
                :label-placeholder="`${$t('MinDeposit')} USDT`"
              ...
              <vs-input
                ...
                style="display: inline-block"
                class="m-2 mb-4"
                :label-placeholder="`${$t('MinWithdraw')} USDT`"
              ...
              <vs-input
                ...
                style="display: inline-block"
                class="m-2 mb-4"
                :label-placeholder="$t('InternalWithdrawalFee')"
              ...
              <vs-input
                ...
                style="display: inline-block"
                class="m-2 mb-4"
                :label-placeholder="$t('BscWithdrawalFee')"
        ...
        <div class="vx-col md:w-1/2 lg:w-6/12 xl:w-6/12 mb-base">
          ...
          <div class="vx-row">
            <div class="vx-col centerx md:w-1/2 lg:w-2/4 xl:w-2/4">
              <p class="mb-4">{{ $t("DefaultWalletUses") }}:</p>
              <ul class="centerx">
                <li class="mb-4">
                  <vs-radio
        ...
        <div class="vx-col mb-base">
          <div class="vx-row">
            ...
            <div class="vx-col centerx lg:w-1/2">
              <p class="my-4">
                <span style="text-decoration: overline"
                  >[THIẾT LẬP HỖ TRỢ]:
                </span>
