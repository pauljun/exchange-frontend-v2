...
if (process.env.NODE_ENV !== 'development') {
  ...
  console.log(` %c trading-faqs  %c LastBuildTime: ${__APP_INFO__['build_time']},commit:${__APP_INFO__['commit']} `, 'color: #fadfa3; background: #030307; padding:5px 0;', 'background: #fadfa3; padding:5px 0;');
}
